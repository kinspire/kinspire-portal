    ...
    return (
      <div className="story-container">
        <Grid container justify="center" alignItems="center" spacing={1}>
          <Grid item xs={12}>
            <Typography variant="h4" style={{ color: getColor(PageView.COURSES) }}>
        ...
        <Grid container className="stories-story" spacing={1}>
          <Grid item xs={6}>
            <div className="stories-story-section-story">
              <Typography variant="h5" style={{ color: getColor(PageView.COURSES) }}>
                STORY
              </Typography>
          ...
          <Grid item xs={6}>
            <div className="stories-story-section stories-story-section-questions">
              ...
              {get(this.state.module, "content.state") === StoryState.FINISHED ? (
                <Typography style={{ color: getColor(PageView.COURSES) }}>
                  Already submitted!
                </Typography>
              ) : (
